...
\usepackage{amssymb}
\usepackage{enumitem}
\usepackage{eso-pic}   % logo hors du bloc titre
...
%% ============================================================
\begin{document}
%% Logo coin haut-gauche, hors du bloc titre
\AddToShipoutPicture*{%
  \AtPageUpperLeft{%
    \hspace{1.5cm}\raisebox{-8cm}{%
      \includegraphics[height=6.5cm]{assets/logo_umpv.png}%
    }%
  }%
}
\maketitle
